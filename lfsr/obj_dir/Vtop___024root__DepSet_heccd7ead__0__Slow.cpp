...
VL_ATTR_COLD void Vtop___024root___eval_initial(Vtop___024root* vlSelf) {
    ...
    vlSelf->__Vtrigrprev__TOP__button = vlSelf->button;
    vlSelf->__Vtrigrprev__TOP__top__DOT__clk = 0U;
}
...
VL_ATTR_COLD void Vtop___024root___eval_initial__TOP(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__lfsr0__DOT__lfsr_reg = 1U;
}
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__act(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(0U)) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @(posedge button)\n");
    }
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__nba(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(0U)) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @(posedge button)\n");
    }
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    // Body
    vlSelf->button = VL_RAND_RESET_I(1);
    vlSelf->seg0 = VL_RAND_RESET_I(7);
    vlSelf->seg1 = VL_RAND_RESET_I(7);
    vlSelf->top__DOT__clk = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__lfsr_out = VL_RAND_RESET_I(8);
    vlSelf->top__DOT__lfsr0__DOT__lfsr_reg = VL_RAND_RESET_I(8);
    vlSelf->top__DOT__lfsr0__DOT__x8 = VL_RAND_RESET_I(1);
    vlSelf->__Vtrigrprev__TOP__button = VL_RAND_RESET_I(1);
    vlSelf->__Vtrigrprev__TOP__top__DOT__clk = VL_RAND_RESET_I(1);
